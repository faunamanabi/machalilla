...
aoi.full <- readOGR(dsn = 'shp', 'machalilla')
...
# format, etc.)
gfc_data <- writeRaster(gfc_data, filename='data\\machalilla.tif',overwrite=TRUE)
...
gfc_thresholded <- threshold_gfc(gfc_data, forest_threshold=forest_threshold, 
                                 filename="data\\machalilla_extract_thresholded.tif",
                                 overwrite=TRUE)
...
write.csv(gfc_stats$loss_table, file='data\\machalilla_losstable.csv', row.names=FALSE)
write.csv(gfc_stats$gain_table, file='data\\machalilla_gaintable.csv', row.names=FALSE)
...
writeRaster(gfc_thresholded_annual, filename='data\\machalilla_thresholded_annual.tif', overwrite=TRUE)
