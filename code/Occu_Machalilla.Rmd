...
Las trampas cámara permanecieron activas desde final de septiembre 204 hasta comienzo de marzo 2015.
 

```{r calendar1,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=11,fig.width=8}
...
```{r calendar2,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=11,fig.width=8}
f.calendar.yr(dataset = machalilla.raw, yr_toplot = 2)
```
...
colnames(cont.per.sp)<-"Numero de fotos"
xtable(cont.per.sp)
```

# Covariables 

Inicialmente se probo con tres covariables para ajustar los modelos de ocupacion. Estas tres covariables fueron: Altitud (elev), Pendiente (slope) y Distancia a la carrterera pavimentada (dis_rd)

La Altitud se obtuvo de ina imagen SRTM del repositorio de [CGIAR](http://srtm.csi.cgiar.org/). La pendiente se ririvo de la altitud y la distancia a las carreteras se obtuvo de un mapa del Ministerio del Medio Ambiente del Ecuador.
...
f.sp.occu.models <- function(sp_number){
  ...
  modelo<-paste("model for: ", as.character(as.character(sp.names[sp_number])),sep="") # fix model name addin species
...
## La cabra (_Eira barbara_)
### Matriz de datos colapsada a 15 dias

```{r mat_sp6,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp9,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp10,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp2,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp5,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp8,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp11,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp12,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp13,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp19,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp20,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
```{r mat_sp22,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
...
## La Ardilla (_Sciurus stramineus_)
### Matriz de datos colapsada a 15 dias

```{r mat_sp23,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,fig.height=6,fig.width=7}
